...
sevilla_with_sherlock = np.asarray(Image.open('../img/sevilla_with_sherlock_4.jpg'))
sherlock_read = read.imgread(sevilla_with_sherlock, bits=4)
plt.imshow(sherlock_read)
plt.show()

sevilla_with_sherlock = np.asarray(Image.open('../img/sevilla_with_strawberries_4.jpg'))
